 ...
 * @author rafael
 */
public class KGreedyCommunityDetector extends GreedyCommunityDetector{

    public KGreedyCommunityDetector(Network network) {
        super(network,"KGreedy",2);
    }
    
    public KGreedyCommunityDetector(Network network, int k) {
        super(network,"KGreedy",k);
    }
