 ...
 * @author rafael
 */
public class HeavyEdgePairingCommunityDetector extends MultilevelCommunityDetector{

    public HeavyEdgePairingCommunityDetector(Network network) {
        super(network,"HeavyEdge");
    }
    ...
    protected boolean coarseningInteration() {
        ...
        //Coarsen Vertex
        for (Edge edge : network.getAllEdgesSortedByWightDesc(level-1)) {
